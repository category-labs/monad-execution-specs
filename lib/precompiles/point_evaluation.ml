...
(* Decompression for G1 and G2 points.
   ...
   As per IRTF, the point serialization scheme is defined by https://github.com/zkcrypto/pairing/blob/0.13.0/src/bls12_381/README.md
...
(* As PolyCom. Note that the result lives in Fₚ but it is returned as an Integer.t *)
