...
(** [delegation_code] returns the delegation code for the given address (the address prefixed by the delegation
    indicator), or the empty code if the address is zero. *)
