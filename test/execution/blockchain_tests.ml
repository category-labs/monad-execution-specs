...
let suppressed_tests =
  Test_entry.Set.of_list
    ...
    ; ("mf_tests/monad_eight/reserve_balance/transfers", 6)
    ; ("mf_tests/monad_eight/reserve_balance/transfers", 7)
    ; ("mf_tests/monad_eight/reserve_balance/transfers", 8)
    ; ("mf_tests/monad_eight/reserve_balance/transfers", 9)
    ...
    ; ("mf_tests/monad_eight/reserve_balance/transfers", 19)
    ; ("mf_tests/monad_eight/reserve_balance/transfers", 20)
    ; ("mf_tests/monad_eight/reserve_balance/transfers", 21)
    ; ("mf_tests/monad_eight/reserve_balance/multi_block", 0)
    ; ("mf_tests/monad_eight/reserve_balance/multi_block", 1)
    ; ("mf_tests/monad_eight/reserve_balance/multi_block", 2)
    ...
    ; ("mf_tests/monad_nine/mip4_checkreservebalance/tx_revert", 0)
