...
Copied from monad/scripts/page_commit_reference.py
...
def _slot1_one() -> bytes:
    page = bytearray(PAGE_SIZE)
    page[SLOT_SIZE + 31] = 0x01
    return bytes(page)

def _slot0_one_slot1_two() -> bytes:
    page = bytearray(PAGE_SIZE)
    page[31] = 0x01
    page[SLOT_SIZE + 31] = 0x02
    return bytes(page)

def _slot1_one_slot2_two() -> bytes:
    page = bytearray(PAGE_SIZE)
    page[SLOT_SIZE + 31] = 0x01
    page[2 * SLOT_SIZE + 31] = 0x02
    return bytes(page)
...
REFERENCE_VECTORS: dict[str, tuple[bytes, str]] = {
    ...
    "slot1_one": (
         _slot1_one(),
         "2319a6bc09c31c06709668fba861f15750009799edf2e6c867d4f0a88774c8a6", 
    ),
    "slot0_one_slot1_two": (
         _slot0_one_slot1_two(),
         "46906319c63bef972eab21b85ebaadda0b3d1648c8cd333be15f61b7dbc96e4e", 
    ),
    "slot1_one_slot2_two": (
         _slot1_one_slot2_two(),
