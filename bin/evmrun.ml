...
module Evm = Evmc.Instantiate (Evmc.DummyHost.M) (Evmc.DummyHost.Make) (Vm.Make (Params))
...
let result, _state = Evmc.DummyHost.M.run (Evm.Vm.execute msg msg.code) Evmc.DummyHost.State.empty
